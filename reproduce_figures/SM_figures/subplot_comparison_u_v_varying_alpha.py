...
# u velocities plot
ax1.plot(alphas, max_u1, label=r'$\tilde{u}_s$', color='black', linewidth=1)
ax1.plot(alphas, max_us, label=r'$\tilde{u}_{\omega}$', linestyle='--', color='black', linewidth=1)
ax1.plot(alphas, max_ul, label=r'$\tilde{u}_L$', linestyle=':', color='black', linewidth=2)
ax1.plot(alphas, max_upd, label=r'$\tilde{u}_{pd}$', color='black', linestyle='dashdot', linewidth=1)
...
# v velocities plot
ax2.plot(alphas, max_v1, label=r'$\tilde{v}_s$', color='black', linewidth=1)
ax2.plot(alphas, max_vs, label=r'$\tilde{v}_{\omega}$', linestyle='--', color='black', linewidth=1)
ax2.plot(alphas, max_vl, label=r'$\tilde{v}_L$', linestyle=':', color='black', linewidth=2)
ax2.plot(alphas, max_vpd, label=r'$\tilde{v}_{pd}$', color='black', linestyle='dashdot', linewidth=1)
...
plt.tight_layout()
plt.savefig('outputs/comparison_u_vs_v_velocities_varying_alpha.png')
