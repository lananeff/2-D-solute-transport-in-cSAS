...
pe_vals = [1000.0000000000003]
base_path = '/home/s2611897/Desktop/FEniCS/Dispersion-2D3D/output/casestudies/spine_leak/AG bc'
file_pattern = '{base_path}/default_case_100_200_{pe_vals}/default_case_100_200_{pe_vals}_concentration.txt'

# Save image location
image_folder = "./figures/paraview figs/fig 10/concentration_int/"

# Define a list of indices (locations) to loop through
locations = [-1]  # These indices correspond to the rows in the data
